...
def fetch_data(language, date):
    ...
    # Print response code and response content for debugging
    print(f"Fetching data for {language} on {date}: Status Code = {response.status_code}")
...
def main():
    ...
    for language in languages:
        ...
        # Save to SQLite with error handling for existing tables
        ...
        with sqlite3.connect(sqlite_path) as conn:
            try:
                ...
                print(f"Error saving data to SQLite for {language}: {e}")
    ...
    with sqlite3.connect(combined_sqlite_path) as combined_conn:
        for language in languages:
            ...
            try:
                ...
                print(f"Error combining data into all_languages.sqlite for {language}: {e}")
